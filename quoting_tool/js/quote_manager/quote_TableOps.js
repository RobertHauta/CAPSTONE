...
function calcTotalValues(){
    ...
    $('#LabHours').html(Number(laborHours.toFixed(3)).toLocaleString('en-US') + " Hrs");
    $('#TotMat').html("$" + Number(matCost.toFixed(2)).toLocaleString('en-US'));
    $('#TotLabor').html("$" + Number(laborCost.toFixed(2)).toLocaleString('en-US'));
    $('#TotCost').html("$" + Number(totalCost.toFixed(2)).toLocaleString('en-US'));
    $('#FinalPrice').html("$" + Number(totalSell.toFixed(2)).toLocaleString('en-US'));
    $('#Margin').html(margin.toFixed(3) + "%");
    $('#Markup').html(markup.toFixed(3) + "%");
    $('#Over\\$').html("$" + Number(overheadCost.toFixed(2)).toLocaleString('en-US'));
    $('#Cont\\$').html("$" + Number(contingencyCost.toFixed(2)).toLocaleString('en-US'));    
    $('#Pro\\$').html("$" + Number(profitCost.toFixed(2)).toLocaleString('en-US'));
    $('#GST').html("$" + Number(gst.toFixed(2)).toLocaleString('en-US'));
}
...
function searchBarHandler(){
    ...
    //if a search is being repeated do nothing
    ...
    //$('.Scrollable').animate({scrollTop: Math.abs($("#QuoteTable tbody tr").eq(highlightedLines[0]).offset().top - $('.Scrollable').offset().top)}, 1000);
    ($("#QuoteTable tbody tr").eq(highlightedLines[0]))[0].scrollIntoView({ behavior: "smooth", block: "center" });
}